...
const LoadingIcon = ({ width = "2em", height = "2em", style = {}, }) => (_jsxs("div", { id: "civic-auth-loading-icon", role: "status", children: [_jsx("style", { children: `
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      ` }), _jsxs("svg", { "aria-hidden": "true", style: {
                display: "inline",
                width,
                height,
