 ...
 */
export declare function createLazyProxy<TUnderlying extends EventRegistrar<TEventMap>, TEventMap extends EventMap>(knownMethods?: (keyof TUnderlying)[]): TUnderlying & Proxy<TUnderlying>;
export {};
